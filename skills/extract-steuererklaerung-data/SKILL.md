---
name: extract-steuererklaerung-data
description: Extract structured fields from steuererklaerung documents.
---

# Extract Steuererklaerung Data

Tax and finance teams use this recipe to extract Steuererklaerung fields from official forms into structured JSON for review, routing, and downstream filing preparation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "steuererklaerung.pdf",
      "url": "https://example.com/documents/steuererklaerung-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-steuererklaerung-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-steuererklaerung-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "steuererklaerung.pdf",
              "fileUrl": "https://example.com/documents/steuererklaerung-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-steuererklaerung-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract steuererklaerung data from the file at [file URL]. Use the extract_document tool with these fields:
