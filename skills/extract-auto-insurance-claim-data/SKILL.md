---
name: extract-auto-insurance-claim-data
description: Extract structured fields from auto insurance claim documents.
---

# Extract Auto Insurance Claim Data

Insurance teams use this recipe to extract Auto Insurance Claim details without manually rekeying policy, claim, coverage, and loss information into claims systems.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "auto-insurance-claim.pdf",
      "url": "https://example.com/documents/auto-insurance-claim-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-auto-insurance-claim-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-auto-insurance-claim-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "auto-insurance-claim.pdf",
              "fileUrl": "https://example.com/documents/auto-insurance-claim-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-auto-insurance-claim-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract auto insurance claim data from the file at [file URL]. Use the extract_document tool with these fields:
