---
name: extract-sales-invoice-data
description: Extract structured fields from sales invoice documents.
---

# Extract Sales Invoice Data

Finance teams use this recipe to extract Sales Invoice fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/sales-invoice-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-sales-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-sales-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/sales-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-sales-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract sales invoice data from the file at [file URL]. Use the extract_document tool with these fields:
