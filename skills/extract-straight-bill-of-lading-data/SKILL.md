---
name: extract-straight-bill-of-lading-data
description: Extract structured fields from straight bill of lading documents.
---

# Extract Straight Bill of Lading Data

Logistics teams use this recipe to turn Straight Bill of Lading PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "straight-bill-of-lading.pdf",
      "url": "https://example.com/documents/straight-bill-of-lading-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
...
```n8n
{
  ...
  "nodes": [
    {
      "parameters": {
        "content": "## Extract Straight Bill of Lading Data\n\nLogistics teams use this recipe to turn Straight Bill of Lading PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.\n\n**Note:** This workflow uses the Iteration Layer community node (`n8n-nodes-iterationlayer`). Install it via Settings > Community Nodes on self-hosted n8n, or add it directly on n8n Cloud with Verified Community Nodes enabled.",
        "height": 280,
        "width": 500,
        "color": 2
      },
      ...
      "id": "extract-straight-bill-of-lading-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-straight-bill-of-lading-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "straight-bill-of-lading.pdf",
              "fileUrl": "https://example.com/documents/straight-bill-of-lading-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-straight-bill-of-lading-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract straight bill of lading data from the file at [file URL]. Use the extract_document tool with these fields:
