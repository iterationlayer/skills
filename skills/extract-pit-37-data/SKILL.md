---
name: extract-pit-37-data
description: Extract structured fields from pit 37 documents.
---

# Extract Pit 37 Data

Tax and finance teams use this recipe to extract Pit 37 fields from official forms into structured JSON for review, routing, and downstream filing preparation.
  ...
  "files": [
    {
      "type": "url",
      "name": "pit-37.pdf",
      "url": "https://example.com/documents/pit-37-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-pit-37-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-pit-37-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "pit-37.pdf",
              "fileUrl": "https://example.com/documents/pit-37-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-pit-37-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract pit 37 data from the file at [file URL]. Use the extract_document tool with these fields:
