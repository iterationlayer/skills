---
name: extract-steuerbescheid-data
description: Extract structured fields from steuerbescheid documents.
---

# Extract Steuerbescheid Data

Tax and finance teams use this recipe to extract Steuerbescheid fields from official forms into structured JSON for review, routing, and downstream filing preparation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "steuerbescheid.pdf",
      "url": "https://example.com/documents/steuerbescheid-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-steuerbescheid-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-steuerbescheid-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/steuerbescheid-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-steuerbescheid-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract steuerbescheid data from the file at [file URL]. Use the extract_document tool with these fields:
