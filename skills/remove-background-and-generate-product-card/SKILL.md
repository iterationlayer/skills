...
E-commerce sellers and marketplace teams take a raw product photo, remove the background to get a clean cutout, then compose it into a branded listing card with the product name, price, and brand — ready for European marketplaces, DTC storefronts, or social media.

## APIs Used

Image Transformation (0.5 credits/request), Image Generation (1 credits/request)
...
func main() {
	...
	transformed, err := client.TransformImage(il.TransformImageRequest{
		File: il.FileInput{Type: "url", Name: "wallet-raw.jpg", Url: "https://cdn.example.com/products/wallet-raw.jpg"},
