---
name: extract-balance-sheet-data
description: Extract structured fields from balance sheet documents.
---

# Extract Balance Sheet Data

Finance teams use this recipe to extract Balance Sheet line items and totals into structured JSON for reporting, analysis, and reconciliation workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/balance-sheet-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-balance-sheet-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-balance-sheet-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/balance-sheet-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-balance-sheet-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract balance sheet data from the file at [file URL]. Use the extract_document tool with these fields:
