---
name: extract-loss-run-report-data
description: Extract structured fields from loss run report documents.
---

# Extract Loss Run Report Data

Insurance teams use this recipe to extract Loss Run Report details without manually rekeying policy, claim, coverage, and loss information into claims systems.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "loss-run-report.pdf",
      "url": "https://example.com/documents/loss-run-report-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-loss-run-report-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-loss-run-report-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "loss-run-report.pdf",
              "fileUrl": "https://example.com/documents/loss-run-report-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-loss-run-report-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract loss run report data from the file at [file URL]. Use the extract_document tool with these fields:
