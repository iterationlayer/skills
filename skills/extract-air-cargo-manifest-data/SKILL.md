---
name: extract-air-cargo-manifest-data
description: Extract structured fields from air cargo manifest documents.
---

# Extract Air Cargo Manifest Data

Logistics teams use this recipe to turn Air Cargo Manifest PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "air-cargo-manifest.pdf",
      "url": "https://example.com/documents/air-cargo-manifest-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-air-cargo-manifest-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-air-cargo-manifest-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "air-cargo-manifest.pdf",
              "fileUrl": "https://example.com/documents/air-cargo-manifest-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-air-cargo-manifest-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract air cargo manifest data from the file at [file URL]. Use the extract_document tool with these fields:
