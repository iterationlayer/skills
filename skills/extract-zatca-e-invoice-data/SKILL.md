---
name: extract-zatca-e-invoice-data
description: Extract structured fields from zatca e-invoice documents.
---
  ...
  "nodes": [
    {
      ...
      "id": "extract-zatca-e-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-zatca-e-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "zatca-e-invoice.pdf",
              "fileUrl": "https://example.com/documents/zatca-e-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-zatca-e-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract zatca e-invoice data from the file at [file URL]. Use the extract_document tool with these fields:
