---
name: extract-declaration-impots-data
description: Extract structured fields from declaration impots documents.
---

# Extract Declaration Impots Data

Tax and finance teams use this recipe to extract Declaration Impots fields from official forms into structured JSON for review, routing, and downstream filing preparation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "declaration-impots.pdf",
      "url": "https://example.com/documents/declaration-impots-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-declaration-impots-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-declaration-impots-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "declaration-impots.pdf",
              "fileUrl": "https://example.com/documents/declaration-impots-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-declaration-impots-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract declaration impots data from the file at [file URL]. Use the extract_document tool with these fields:
