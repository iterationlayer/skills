---
name: extract-proforma-invoice-data
description: Extract structured fields from proforma invoice documents.
---

# Extract Proforma Invoice Data

Finance teams use this recipe to extract Proforma Invoice fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/proforma-invoice-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-proforma-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-proforma-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/proforma-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-proforma-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract proforma invoice data from the file at [file URL]. Use the extract_document tool with these fields:
