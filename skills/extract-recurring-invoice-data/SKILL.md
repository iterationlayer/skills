---
name: extract-recurring-invoice-data
description: Extract structured fields from recurring invoice documents.
---

# Extract Recurring Invoice Data

Finance teams use this recipe to extract Recurring Invoice fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "recurring-invoice.pdf",
      "url": "https://example.com/documents/recurring-invoice-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-recurring-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-recurring-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/recurring-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-recurring-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract recurring invoice data from the file at [file URL]. Use the extract_document tool with these fields:
