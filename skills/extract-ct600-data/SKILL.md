---
name: extract-ct600-data
description: Extract structured fields from ct600 documents.
---

# Extract CT600 Data

Tax and finance teams use this recipe to extract CT600 fields from official forms into structured JSON for review, routing, and downstream filing preparation.
  ...
  "files": [
    {
      "type": "url",
      "name": "ct600.pdf",
      "url": "https://example.com/documents/ct600-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-ct600-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
          ...
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "ct600.pdf",
              "fileUrl": "https://example.com/documents/ct600-sample.pdf"
            }
          ]
        }
      },
...
```prompt
Extract ct600 data from the file at [file URL]. Use the extract_document tool with these fields:
