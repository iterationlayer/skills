---
name: extract-p11d-data
description: Extract structured fields from p11d documents.
---

# Extract P11D Data

Finance teams use this recipe to extract P11D fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      "type": "url",
      "name": "p11d.pdf",
      "url": "https://example.com/documents/p11d-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
          ...
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "p11d.pdf",
              "fileUrl": "https://example.com/documents/p11d-sample.pdf"
            }
          ]
        }
      },
...
```prompt
Extract p11d data from the file at [file URL]. Use the extract_document tool with these fields:
