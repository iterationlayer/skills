...
Image Generation (1 credits/request)
  ...
  -d '{
    ...
    "layers": [
      ...
      },
      {
        "index": 5,
        "type": "text",
        "text": "412 Ridgewood Lane, Berlin 10115",
        "font_name": "Inter",
        "font_size_in_px": 22,
        "font_weight": "regular",
        "text_color": "#CBD5E1",
...
func main() {
	...
	result, err := client.GenerateImage(il.GenerateImageRequest{
		...
		Layers: []il.Layer{
			il.NewImageLayer(
				0,
				il.FileInput{Type: "url", Name: "property.jpg", Url: "https://example.com/properties/412-ridgewood.jpg"},
			...
			il.NewTextLayer(4, "EUR 685,000", "Inter", 52, "#FFFFFF",
				il.Position{XInPx: 40, YInPx: 740},
				il.Dimensions{WidthInPx: 700, HeightInPx: 72},
			),
			il.NewTextLayer(5, "412 Ridgewood Lane, Berlin 10115", "Inter", 22, "#CBD5E1",
			...
			il.NewTextLayer(7, "Hanse Realty GmbH", "Inter", 18, "#64748B",
