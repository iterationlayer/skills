---
name: extract-certificate-of-origin-data
description: Extract structured fields from certificate of origin documents.
---

# Extract Certificate of Origin Data

Logistics teams use this recipe to turn Certificate of Origin PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/certificate-of-origin-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
...
```n8n
{
  ...
  "nodes": [
    {
      "parameters": {
        "content": "## Extract Certificate of Origin Data\n\nLogistics teams use this recipe to turn Certificate of Origin PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.\n\n**Note:** This workflow uses the Iteration Layer community node (`n8n-nodes-iterationlayer`). Install it via Settings > Community Nodes on self-hosted n8n, or add it directly on n8n Cloud with Verified Community Nodes enabled.",
        "height": 280,
        "width": 500,
        "color": 2
      },
      ...
      "id": "extract-certificate-of-origin-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-certificate-of-origin-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/certificate-of-origin-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-certificate-of-origin-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract certificate of origin data from the file at [file URL]. Use the extract_document tool with these fields:
