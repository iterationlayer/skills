---
name: extract-modello-f24-data
description: Extract structured fields from modello f24 documents.
---

# Extract Modello F24 Data

Tax and finance teams use this recipe to extract Modello F24 fields from official forms into structured JSON for review, routing, and downstream filing preparation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "modello-f24.pdf",
      "url": "https://example.com/documents/modello-f24-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-modello-f24-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-modello-f24-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "modello-f24.pdf",
              "fileUrl": "https://example.com/documents/modello-f24-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-modello-f24-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract modello f24 data from the file at [file URL]. Use the extract_document tool with these fields:
