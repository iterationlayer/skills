---
name: extract-title-insurance-data
description: Extract structured fields from title insurance documents.
---

# Extract Title Insurance Data

Insurance teams use this recipe to extract Title Insurance details without manually rekeying policy, claim, coverage, and loss information into claims systems.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/title-insurance-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-title-insurance-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-title-insurance-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "title-insurance.pdf",
              "fileUrl": "https://example.com/documents/title-insurance-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-title-insurance-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract title insurance data from the file at [file URL]. Use the extract_document tool with these fields:
