---
name: extract-closing-statement-data
description: Extract structured fields from closing statement documents.
---

# Extract Closing Statement Data

Real estate and lending teams use this recipe to extract Closing Statement details into structured records for loan files, title review, lease administration, or portfolio systems.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "closing-statement.pdf",
      "url": "https://example.com/documents/closing-statement-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-closing-statement-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-closing-statement-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/closing-statement-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-closing-statement-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract closing statement data from the file at [file URL]. Use the extract_document tool with these fields:
