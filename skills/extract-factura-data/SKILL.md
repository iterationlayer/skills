---
name: extract-factura-data
description: Extract structured fields from factura documents.
---

# Extract Factura Data

Finance teams use this recipe to extract Factura fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      "type": "url",
      "name": "factura.pdf",
      "url": "https://example.com/documents/factura-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-factura-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-factura-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/factura-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-factura-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract factura data from the file at [file URL]. Use the extract_document tool with these fields:
