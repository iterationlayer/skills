      ...
      "footer": [
        {
          "type": "paragraph",
          "runs": [{
            "text": "Cascade Systems GmbH · 350 Spear Street, Suite 900, Berlin, DE 94105 · cascadesystems.com"
          }]
        }
      ],
      "content": [
        ...
        { "type": "paragraph", "runs": [
          ...
          { "text": " at Cascade Systems GmbH We were impressed by your experience and believe you will be a valuable addition to our engineering team. Below are the details of your offer." }
        ] },
        { "type": "paragraph", "runs": [
          {
              "text": "Role: ",
	...
	result, err := client.GenerateDocument(il.GenerateDocumentRequest{
      ...
      LeftInPt: 72,
			...
			Content: []il.ContentBlock{
				il.NewHeadlineBlock("h1", "Cascade Systems GmbH"),
				il.ParagraphBlock{
      Type: "paragraph",
      Markdown: "March 14,
      2026",
      ...
      ",
				...
				il.ParagraphBlock{
      Type: "paragraph",
      Markdown: "We are pleased to offer you the position of **Senior Software Engineer** at Cascade Systems GmbH",
    },
