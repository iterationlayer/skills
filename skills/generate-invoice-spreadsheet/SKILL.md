...
Sheet Generation (1 credits/request)
  ...
  -d '{
    ...
    "sheets": [
      ...
      "rows": [
        [
          {
            "value": "Nordlicht Consulting GmbH — Invoice #2026-0187",
            "styles": {
              "is_bold": true,
              "font_size_in_pt": 14,
            },
        ...
        [
          {
            "value": "Bill To: Musterwerk GmbH, Invalidenstrasse 91, 10115 Berlin",
            "from_col": 0,
            "to_col": 3,
          }
        ],
  ...
  sheets: [
    {
      ...
      rows: [
        ...
        [
          {
            value:
              "Bill To: Musterwerk GmbH, Invalidenstrasse 91, 10115 Berlin",
            from_col: 0,
            to_col: 3,
          },
        ],
