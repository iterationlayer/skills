---
name: extract-ksef-faktura-data
description: Extract structured fields from ksef faktura documents.
---

# Extract Ksef Faktura Data

Finance teams use this recipe to extract Ksef Faktura fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "ksef-faktura.pdf",
      "url": "https://example.com/documents/ksef-faktura-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-ksef-faktura-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-ksef-faktura-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "ksef-faktura.pdf",
              "fileUrl": "https://example.com/documents/ksef-faktura-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-ksef-faktura-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract ksef faktura data from the file at [file URL]. Use the extract_document tool with these fields:
