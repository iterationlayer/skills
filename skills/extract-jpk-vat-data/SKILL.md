---
name: extract-jpk-vat-data
description: Extract structured fields from jpk vat documents.
---

# Extract Jpk Vat Data

Tax and finance teams use this recipe to extract Jpk Vat fields from official forms into structured JSON for review, routing, and downstream filing preparation.
  ...
  "files": [
    {
      "type": "url",
      "name": "jpk-vat.pdf",
      "url": "https://example.com/documents/jpk-vat-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-jpk-vat-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-jpk-vat-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "jpk-vat.pdf",
              "fileUrl": "https://example.com/documents/jpk-vat-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-jpk-vat-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract jpk vat data from the file at [file URL]. Use the extract_document tool with these fields:
