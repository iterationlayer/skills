---
name: extract-sa100-data
description: Extract structured fields from sa100 documents.
---

# Extract SA100 Data

Tax and finance teams use this recipe to extract SA100 fields from official forms into structured JSON for review, routing, and downstream filing preparation.
  ...
  "files": [
    {
      "type": "url",
      "name": "sa100.pdf",
      "url": "https://example.com/documents/sa100-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-sa100-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
          ...
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "sa100.pdf",
              "fileUrl": "https://example.com/documents/sa100-sample.pdf"
            }
          ]
        }
      },
...
```prompt
Extract sa100 data from the file at [file URL]. Use the extract_document tool with these fields:
