---
name: extract-property-survey-data
description: Extract structured fields from property survey documents.
---

# Extract Property Survey Data

Real estate and lending teams use this recipe to extract Property Survey details into structured records for loan files, title review, lease administration, or portfolio systems.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/property-survey-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-property-survey-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-property-survey-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/property-survey-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-property-survey-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract property survey data from the file at [file URL]. Use the extract_document tool with these fields:
