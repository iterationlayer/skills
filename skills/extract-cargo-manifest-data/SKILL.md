---
name: extract-cargo-manifest-data
description: Extract structured fields from cargo manifest documents.
---
  ...
  "nodes": [
    {
      ...
      "id": "extract-cargo-manifest-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-cargo-manifest-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "cargo-manifest.pdf",
              "fileUrl": "https://example.com/documents/cargo-manifest-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-cargo-manifest-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract cargo manifest data from the file at [file URL]. Use the extract_document tool with these fields:
