---
name: extract-rechnung-data
description: Extract structured fields from rechnung documents.
---

# Extract Rechnung Data

Finance teams use this recipe to extract Rechnung fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      "type": "url",
      "name": "rechnung.pdf",
      "url": "https://example.com/documents/rechnung-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-rechnung-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-rechnung-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/rechnung-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-rechnung-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract rechnung data from the file at [file URL]. Use the extract_document tool with these fields:
