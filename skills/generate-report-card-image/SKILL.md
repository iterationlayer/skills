...
func main() {
	...
	result, err := client.GenerateImage(il.GenerateImageRequest{
		...
		Layers: []il.Layer{
			...
			il.NewTextLayer(3, "EUR 124,800", "Inter", 72, "#F8FAFC",
			...
			il.NewTextLayer(8, "Avg deal size: EUR 365", "Inter", 16, "#CBD5E1",
				il.Position{XInPx: 420, YInPx: 304},
				il.Dimensions{WidthInPx: 300, HeightInPx: 28},
			),
			il.NewTextLayer(9, "MRR: EUR 41,600", "Inter", 16, "#CBD5E1",
