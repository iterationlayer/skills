  ...
  document: {
    ...
    content: [
      ...
      { type: "headline", level: "h3", text: "Portfolio Summary" },
      {
        ...
        rows: [
          { cells: [{ text: "Total AUM" }, { text: "EUR 14,250,000" }] },
      ...
      { type: "headline", level: "h3", text: "Asset Allocation" },
      {
        ...
        rows: [
          { cells: [{ text: "US Equities" }, { text: "45%" }, { text: "EUR 6,412,500" }] },
          { cells: [{ text: "International Equities" }, { text: "20%" }, { text: "EUR 2,850,000" }] },
          { cells: [{ text: "Fixed Income" }, { text: "25%" }, { text: "EUR 3,562,500" }] },
          { cells: [{ text: "Alternatives" }, { text: "10%" }, { text: "EUR 1,425,000" }] },
        ],
      },
      { type: "separator" },
	...
	_, err := client.GenerateDocument(il.GenerateDocumentRequest{
		...
		Document: il.DocumentDefinition{
			...
			Content: []il.ContentBlock{
				...
				il.ContentBlock{"type": "table", "header": map[string]any{"cells": []map[string]string{{"text": "Metric"}, {"text": "Value"}}}, "rows": []map[string]any{{"cells": []map[string]string{{"text": "Total AUM"}, {"text": "EUR 14,250,000"}}}, {"cells": []map[string]string{{"text": "Monthly Return"}, {"text": "+1.8%"}}}, {"cells": []map[string]string{{"text": "YTD Return"}, {"text": "+5.4%"}}}}},
				il.ContentBlock{"type": "separator"},
