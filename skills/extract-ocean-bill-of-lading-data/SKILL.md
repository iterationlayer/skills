---
name: extract-ocean-bill-of-lading-data
description: Extract structured fields from ocean bill of lading documents.
---

# Extract Ocean Bill of Lading Data

Logistics teams use this recipe to turn Ocean Bill of Lading PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "ocean-bill-of-lading.pdf",
      "url": "https://example.com/documents/ocean-bill-of-lading-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-ocean-bill-of-lading-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-ocean-bill-of-lading-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "ocean-bill-of-lading.pdf",
              "fileUrl": "https://example.com/documents/ocean-bill-of-lading-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-ocean-bill-of-lading-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract ocean bill of lading data from the file at [file URL]. Use the extract_document tool with these fields:
