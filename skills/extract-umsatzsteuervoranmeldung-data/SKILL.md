---
name: extract-umsatzsteuervoranmeldung-data
description: Extract structured fields from umsatzsteuervoranmeldung documents.
---

# Extract Umsatzsteuervoranmeldung Data

Tax and finance teams use this recipe to extract Umsatzsteuervoranmeldung fields from official forms into structured JSON for review, routing, and downstream filing preparation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "umsatzsteuervoranmeldung.pdf",
      "url": "https://example.com/documents/umsatzsteuervoranmeldung-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
...
```n8n
{
  ...
  "nodes": [
    {
      "parameters": {
        "content": "## Extract Umsatzsteuervoranmeldung Data\n\nTax and finance teams use this recipe to extract Umsatzsteuervoranmeldung fields from official forms into structured JSON for review, routing, and downstream filing preparation.\n\n**Note:** This workflow uses the Iteration Layer community node (`n8n-nodes-iterationlayer`). Install it via Settings > Community Nodes on self-hosted n8n, or add it directly on n8n Cloud with Verified Community Nodes enabled.",
        "height": 280,
        "width": 500,
        "color": 2
      },
      ...
      "id": "extract-umsatzsteuervoranmeldung-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-umsatzsteuervoranmeldung-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "umsatzsteuervoranmeldung.pdf",
              "fileUrl": "https://example.com/documents/umsatzsteuervoranmeldung-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-umsatzsteuervoranmeldung-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract umsatzsteuervoranmeldung data from the file at [file URL]. Use the extract_document tool with these fields:
