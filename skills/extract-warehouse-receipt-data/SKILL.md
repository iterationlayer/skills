---
name: extract-warehouse-receipt-data
description: Extract structured fields from warehouse receipt documents.
---

# Extract Warehouse Receipt Data

Logistics teams use this recipe to turn Warehouse Receipt PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "warehouse-receipt.pdf",
      "url": "https://example.com/documents/warehouse-receipt-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-warehouse-receipt-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-warehouse-receipt-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/warehouse-receipt-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-warehouse-receipt-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract warehouse receipt data from the file at [file URL]. Use the extract_document tool with these fields:
