---
name: extract-property-insurance-claim-data
description: Extract structured fields from property insurance claim documents.
---

# Extract Property Insurance Claim Data

Insurance teams use this recipe to extract Property Insurance Claim details without manually rekeying policy, claim, coverage, and loss information into claims systems.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "property-insurance-claim.pdf",
      "url": "https://example.com/documents/property-insurance-claim-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
...
```n8n
{
  ...
  "nodes": [
    {
      "parameters": {
        "content": "## Extract Property Insurance Claim Data\n\nInsurance teams use this recipe to extract Property Insurance Claim details without manually rekeying policy, claim, coverage, and loss information into claims systems.\n\n**Note:** This workflow uses the Iteration Layer community node (`n8n-nodes-iterationlayer`). Install it via Settings > Community Nodes on self-hosted n8n, or add it directly on n8n Cloud with Verified Community Nodes enabled.",
        "height": 280,
        "width": 500,
        "color": 2
      },
      ...
      "id": "extract-property-insurance-claim-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-property-insurance-claim-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "property-insurance-claim.pdf",
              "fileUrl": "https://example.com/documents/property-insurance-claim-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-property-insurance-claim-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract property insurance claim data from the file at [file URL]. Use the extract_document tool with these fields:
