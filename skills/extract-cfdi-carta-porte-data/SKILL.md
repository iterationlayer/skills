---
name: extract-cfdi-carta-porte-data
description: Extract structured fields from cfdi carta porte documents.
---

# Extract CFDI Carta Porte Data

Logistics teams use this recipe to turn CFDI Carta Porte PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "cfdi-carta-porte.pdf",
      "url": "https://example.com/documents/cfdi-carta-porte-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-cfdi-carta-porte-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-cfdi-carta-porte-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "cfdi-carta-porte.pdf",
              "fileUrl": "https://example.com/documents/cfdi-carta-porte-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-cfdi-carta-porte-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract cfdi carta porte data from the file at [file URL]. Use the extract_document tool with these fields:
