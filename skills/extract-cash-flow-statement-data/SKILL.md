---
name: extract-cash-flow-statement-data
description: Extract structured fields from cash flow statement documents.
---

# Extract Cash Flow Statement Data

Tax and finance teams use this recipe to extract Cash Flow Statement fields from official forms into structured JSON for review, routing, and downstream filing preparation.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/cash-flow-statement-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-cash-flow-statement-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-cash-flow-statement-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/cash-flow-statement-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-cash-flow-statement-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract cash flow statement data from the file at [file URL]. Use the extract_document tool with these fields:
