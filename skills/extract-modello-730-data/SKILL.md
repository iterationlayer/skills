---
name: extract-modello-730-data
description: Extract structured fields from modello 730 documents.
---

# Extract Modello 730 Data

Tax and finance teams use this recipe to extract Modello 730 fields from official forms into structured JSON for review, routing, and downstream filing preparation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "modello-730.pdf",
      "url": "https://example.com/documents/modello-730-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-modello-730-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-modello-730-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "modello-730.pdf",
              "fileUrl": "https://example.com/documents/modello-730-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-modello-730-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract modello 730 data from the file at [file URL]. Use the extract_document tool with these fields:
