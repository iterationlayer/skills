---
name: extract-certificazione-unica-data
description: Extract structured fields from certificazione unica documents.
---

# Extract Certificazione Unica Data

Payroll and HR teams use this recipe to extract Certificazione Unica fields into structured JSON for payroll checks, employee records, and finance reconciliation.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "certificazione-unica.pdf",
      "url": "https://example.com/documents/certificazione-unica-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-certificazione-unica-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-certificazione-unica-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/certificazione-unica-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-certificazione-unica-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract certificazione unica data from the file at [file URL]. Use the extract_document tool with these fields:
