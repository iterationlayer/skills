---
name: extract-aging-report-data
description: Extract structured fields from aging report documents.
---

# Extract Aging Report Data

Finance teams use this recipe to extract Aging Report line items and totals into structured JSON for reporting, analysis, and reconciliation workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/aging-report-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-aging-report-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-aging-report-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/aging-report-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-aging-report-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract aging report data from the file at [file URL]. Use the extract_document tool with these fields:
