---
name: extract-bill-of-lading-data
description: Extract structured fields from bill of lading documents.
---

# Extract Bill of Lading Data

Logistics teams use this recipe to turn Bill of Lading PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/bill-of-lading-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-bill-of-lading-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-bill-of-lading-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/bill-of-lading-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-bill-of-lading-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract bill of lading data from the file at [file URL]. Use the extract_document tool with these fields:
