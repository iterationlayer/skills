---
name: extract-pit-11-data
description: Extract structured fields from pit 11 documents.
---

# Extract Pit 11 Data

Tax and finance teams use this recipe to extract Pit 11 fields from official forms into structured JSON for review, routing, and downstream filing preparation.
  ...
  "files": [
    {
      "type": "url",
      "name": "pit-11.pdf",
      "url": "https://example.com/documents/pit-11-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-pit-11-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-pit-11-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "pit-11.pdf",
              "fileUrl": "https://example.com/documents/pit-11-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-pit-11-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract pit 11 data from the file at [file URL]. Use the extract_document tool with these fields:
