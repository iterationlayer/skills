---
name: extract-ro-e-factura-data
description: Extract structured fields from ro e-factura documents.
---

# Extract RO e-Factura Data

Finance teams use this recipe to extract RO e-Factura fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "ro-e-factura.pdf",
      "url": "https://example.com/documents/ro-e-factura-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-ro-e-factura-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-ro-e-factura-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "ro-e-factura.pdf",
              "fileUrl": "https://example.com/documents/ro-e-factura-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-ro-e-factura-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract ro e-factura data from the file at [file URL]. Use the extract_document tool with these fields:
