...
func main() {
	...
	extraction, err := client.ExtractDocument(il.ExtractDocumentRequest{
		Files: []il.FileInput{
			il.FileInput{Type: "url", Name: "application-chen.pdf", Url: "https://example.com/applications/application-chen.pdf"},
			il.FileInput{Type: "url", Name: "application-okafor.pdf", Url: "https://example.com/applications/application-okafor.pdf"},
			il.FileInput{Type: "url", Name: "application-petrov.pdf", Url: "https://example.com/applications/application-petrov.pdf"},
		},
		Schema: il.ExtractionSchema{
			Fields: []any{
				il.ArrayFieldConfig{
					...
					Description: "One entry per rental application",
					Fields: []any{
						il.TextFieldConfig{Name: "applicant_name", Type: "TEXT", Description: "Full name of applicant"},
						il.EmailFieldConfig{Name: "email", Type: "EMAIL", Description: "Applicant email address"},
						il.CurrencyAmountFieldConfig{Name: "monthly_income", Type: "CURRENCY_AMOUNT", Description: "Stated monthly income"},
						il.CurrencyCodeFieldConfig{Name: "currency", Type: "CURRENCY_CODE", Description: "Income currency"},
						il.TextFieldConfig{Name: "employer", Type: "TEXT", Description: "Current employer name"},
						il.EnumFieldConfig{Name: "employment_status", Type: "ENUM", Description: "Employment status", Values: []string{"Full-time", "Part-time", "Self-employed", "Unemployed", "Retired"}},
						il.DateFieldConfig{Name: "desired_move_in_date", Type: "DATE", Description: "Requested move-in date"},
						il.BooleanFieldConfig{Name: "has_pets", Type: "BOOLEAN", Description: "Whether the applicant has pets"},
					},
				},
			},
		},
