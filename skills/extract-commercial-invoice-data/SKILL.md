---
name: extract-commercial-invoice-data
description: Extract structured fields from commercial invoice documents.
---

# Extract Commercial Invoice Data

Finance teams use this recipe to extract Commercial Invoice fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      ...
      "url": "https://example.com/documents/commercial-invoice-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-commercial-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-commercial-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/commercial-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-commercial-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract commercial invoice data from the file at [file URL]. Use the extract_document tool with these fields:
