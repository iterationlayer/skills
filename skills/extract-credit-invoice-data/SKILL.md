---
name: extract-credit-invoice-data
description: Extract structured fields from credit invoice documents.
---

# Extract Credit Invoice Data

Finance teams use this recipe to extract Credit Invoice fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "credit-invoice.pdf",
      "url": "https://example.com/documents/credit-invoice-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-credit-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-credit-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "credit-invoice.pdf",
              "fileUrl": "https://example.com/documents/credit-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-credit-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract credit invoice data from the file at [file URL]. Use the extract_document tool with these fields:
