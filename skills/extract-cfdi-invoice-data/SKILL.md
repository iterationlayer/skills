---
name: extract-cfdi-invoice-data
description: Extract structured fields from cfdi invoice documents.
---

# Extract CFDI Invoice Data

Finance teams use this recipe to extract CFDI Invoice fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "cfdi-invoice.pdf",
      "url": "https://example.com/documents/cfdi-invoice-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-cfdi-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-cfdi-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "cfdi-invoice.pdf",
              "fileUrl": "https://example.com/documents/cfdi-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-cfdi-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract cfdi invoice data from the file at [file URL]. Use the extract_document tool with these fields:
