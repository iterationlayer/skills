---
name: extract-insurance-claim-data
description: Extract structured fields from insurance claim documents.
---
  ...
  "nodes": [
    {
      ...
      "id": "extract-insurance-claim-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-insurance-claim-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/insurance-claim-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-insurance-claim-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract insurance claim data from the file at [file URL]. Use the extract_document tool with these fields:
