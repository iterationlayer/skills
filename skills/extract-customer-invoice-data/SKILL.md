---
name: extract-customer-invoice-data
description: Extract structured fields from customer invoice documents.
---
  ...
  "nodes": [
    {
      ...
      "id": "extract-customer-invoice-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-customer-invoice-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/customer-invoice-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-customer-invoice-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract customer invoice data from the file at [file URL]. Use the extract_document tool with these fields:
