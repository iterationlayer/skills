---
name: extract-dichiarazione-iva-data
description: Extract structured fields from dichiarazione iva documents.
---
  ...
  "nodes": [
    {
      ...
      "id": "extract-dichiarazione-iva-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-dichiarazione-iva-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "dichiarazione-iva.pdf",
              "fileUrl": "https://example.com/documents/dichiarazione-iva-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-dichiarazione-iva-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract dichiarazione iva data from the file at [file URL]. Use the extract_document tool with these fields:
