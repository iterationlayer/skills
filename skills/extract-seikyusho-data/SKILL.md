---
name: extract-seikyusho-data
description: Extract structured fields from seikyusho documents.
---

# Extract Seikyusho Data

Finance teams use this recipe to extract Seikyusho fields into structured JSON for accounts receivable, accounts payable, tax, and ERP workflows.
  ...
  "files": [
    {
      "type": "url",
      "name": "seikyusho.pdf",
      "url": "https://example.com/documents/seikyusho-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-seikyusho-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-seikyusho-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "seikyusho.pdf",
              "fileUrl": "https://example.com/documents/seikyusho-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-seikyusho-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract seikyusho data from the file at [file URL]. Use the extract_document tool with these fields:
