---
name: extract-bill-of-entry-data
description: Extract structured fields from bill of entry documents.
---

# Extract Bill of Entry Data

Logistics teams use this recipe to turn Bill of Entry PDFs into structured shipment records. Extract parties, route details, goods, weights, and values for customs, tracking, or transportation workflows.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "bill-of-entry.pdf",
      "url": "https://example.com/documents/bill-of-entry-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-bill-of-entry-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-bill-of-entry-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
        ...
        "files": {
          "fileValues": [
            {
              "fileInputMode": "url",
              "fileName": "bill-of-entry.pdf",
              "fileUrl": "https://example.com/documents/bill-of-entry-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-bill-of-entry-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract bill of entry data from the file at [file URL]. Use the extract_document tool with these fields:
