---
name: extract-home-inspection-data
description: Extract structured fields from home inspection documents.
---

# Extract Home Inspection Data

Real estate and lending teams use this recipe to extract Home Inspection details into structured records for loan files, title review, lease administration, or portfolio systems.
...
curl -X POST https://api.iterationlayer.com/document-extraction/v1/extract \
  ...
  "files": [
    {
      "type": "url",
      "name": "home-inspection.pdf",
      "url": "https://example.com/documents/home-inspection-sample.pdf"
    }
  ],
  "schema": {
    "fields": [
  ...
  "nodes": [
    {
      ...
      "id": "extract-home-inspection-data-overview",
      "name": "Overview"
    },
    {
      "parameters": {},
      ...
      "id": "extract-home-inspection-data-trigger",
      "name": "Manual Trigger"
    },
    {
      "parameters": {
          ...
          "fileValues": [
            {
              ...
              "fileUrl": "https://example.com/documents/home-inspection-sample.pdf"
            }
          ]
        }
      },
      ...
      "id": "extract-home-inspection-data-extract",
      "name": "Extract Data",
      "credentials": {
        "iterationLayerApi": {
          "id": "1",
...
```prompt
Extract home inspection data from the file at [file URL]. Use the extract_document tool with these fields:
